...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Document settings
\title{Digitisation of Historical Inscriptions and Manuscripts}
\subCode{XX367P}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Student Details%%%
\stuNameA{Manish Tandurkar}
\stuUSNA{1RV23CS128}
\stuNameB{Nikhil N Bharadwaj}
\stuUSNB{1RV23CS153}
\stuNameC{Ajay Viswanathan S}
\stuUSNC{1RV23EC012}
\stuNameD{Vijay Kumar MD}
\stuUSND{1RV24IM403}
...
\guideDeptA[CSE]{Computer science and Engineering - Data Science}
...
%% Pannel Members %%
\panelMemberNameA{Prof. Shweta Babu Prasad}
\panelMemberDesigA{Assistant Professor}
\panelMemberDeptA[CY]{Computer Science and Engineering - Cyber Security}
...
\projectCoOrdNameA{Dr. Jyoti Shetty}
\projectCoOrdDesigA{Associate Professor}
\projectCoOrdDeptA[CD]{Computer Science and Engineering - Data Science}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%  QRL %%%%%%%%%%%%%%%%%%%%%%%%%%
\QRurl{https://q.me-qr.com/6f70quu5}
...
% Force all glossary entries to appear (no \gls{} citations needed in text)
\glsaddall
