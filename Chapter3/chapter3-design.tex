...
The THPLMD dataset provides the most rigorous evaluation baseline because it includes expert-validated binarised ground truth, enabling quantitative CER computation for the palm leaf category. The Kaggle Tamil Stone Inscriptions dataset includes 3D point cloud models alongside photographs, supporting future Phase 3 work on depth-enhanced enhancement.
...
The Brahmi Character Dataset is the planned training resource for the custom Phase 2 Brahmi OCR model. The Indiscapes dataset provides layout annotation methodology that can extend the pipeline's page segmentation capabilities for multi-column Indic manuscript layouts.
